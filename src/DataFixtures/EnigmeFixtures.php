...
class EnigmeFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $enigme1->setCodeSecret('Bravo');
        $enigme1->setCodeReponse('A1');
        $enigme1->setOrdre(1);
        $enigme1->setType($this->getReference(TypeFixtures::TYPE_LOGIQUE, Type::class));
        ...
        $enigme3->setCodeSecret('Phishing');
        ...
        $enigme4->setCodeSecret('Machine Learning');
