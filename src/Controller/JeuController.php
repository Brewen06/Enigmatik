...
final class JeuController extends AbstractController
{
    ...
    #[Route('/creer', name: 'app_jeu_creer', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('jeu/creer.html.twig', [
            'jeu' => $jeu,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_jeu_liste', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_jeu_game_edit', methods: ['GET', 'POST'])]
    public function editGame(Request $request, Jeu $jeu, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(JeuType::class, $jeu);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_jeu_liste', ['id' => $jeu->getId()], Response::HTTP_SEE_OTHER);
        }
