 ...
 */
final class Version20251204093525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parametre (id INT AUTO_INCREMENT NOT NULL, jeu_id INT DEFAULT NULL, INDEX IDX_ACC790418C9E392E (jeu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tbl_enigme (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, vignette_id INT DEFAULT NULL, jeu_id INT DEFAULT NULL, ordre INT NOT NULL, titre VARCHAR(50) NOT NULL, consigne LONGTEXT NOT NULL, code_secret VARCHAR(50) NOT NULL, INDEX IDX_A4627AC8C54C8C93 (type_id), UNIQUE INDEX UNIQ_A4627AC87D16298B (vignette_id), INDEX IDX_A4627AC88C9E392E (jeu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tbl_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tbl_enigme ADD CONSTRAINT FK_A4627AC88C9E392E FOREIGN KEY (jeu_id) REFERENCES tbl_jeu (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_enigme DROP FOREIGN KEY FK_A4627AC88C9E392E');
